/**
 * SpectraChartNew - Refactored spectra visualization for backend data
 *
 * Features:
...
interface SpectraChartNewProps {
...
export function SpectraChartNew({
  original,
  processed,
  y,
  sampleIds,
...
export default SpectraChartNew;
