...
export const SYNTHESIS_STEPS: SynthesisStepDefinition[] = [
  // === Basic ===
  {
    ...
    name: "Features",
    description: "Configure spectral feature generation including wavelength range, complexity, and components",
    category: "basic",
    icon: "Waves",
    color: {
    ...
    parameters: [
      ...
      },
      {
        ...
        default: "simple",
        options: [
          { value: "simple", label: "Simple", description: "Minimal noise, fast generation" },
          { value: "realistic", label: "Realistic", description: "Typical NIR noise and scatter" },
          { value: "complex", label: "Complex", description: "High noise, artifacts, challenging" },
        ],
        description: "Level of spectral complexity and noise",
      },
      {
        name: "components",
        label: "Components",
