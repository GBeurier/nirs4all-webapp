  ...
  settings: {
    ...
    workspace: {
      ...
      backup: {
        ...
        description: "Konfigurieren Sie automatische Arbeitsbereich-Sicherungen",
        enabled: "Automatische Sicherungen aktivieren",
        interval: "Sicherungsintervall",
        intervalHours: "{{count}} Stunde",
        intervalHours_other: "{{count}} Stunden",
        maxBackups: "Maximale Anzahl aufzubewahrender Sicherungen",
        includeResults: "Ergebnisse einschließen",
        includeModels: "Modelle einschließen",
        saveSettings: "Sicherungseinstellungen speichern",
