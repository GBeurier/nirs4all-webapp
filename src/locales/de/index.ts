...
const de = {
  ...
  settings: {
    ...
    dataDefaults: {
      ...
      missing: {
        ...
        policies: {
          auto: "Auto (Fehler bei NA)",
          abort: "Fehler bei NA",
          remove_sample: "Proben mit NA entfernen",
          remove_feature: "Merkmale mit NA entfernen",
          replace: "NA-Werte ersetzen",
          ignore: "Ignorieren (im Pipeline behandeln)",
        },
        fillConfig: "Ersetzungskonfiguration",
        fillMethod: "Ersetzungsmethode",
        fillMethodDescription: "Methode zum Ersetzen fehlender Werte",
        fillValue: "Ersetzungswert",
        fillValueDescription: "Konstanter Wert für die Ersetzung",
        fillMethods: {
          value: "Konstanter Wert",
          mean: "Spaltenmittelwert",
          median: "Spaltenmedian",
          forward_fill: "Vorwärtsfüllung",
          backward_fill: "Rückwärtsfüllung",
        },
      },
  ...
  inspector: {
    ...
    panels: {
      ...
      candlestick: "Boxplot",
      branch_comparison: "Branchenvergleich",
      branch_topology: "Branchentopologie",
      fold_stability: "Fold-Stabilität",
      preprocessing_impact: "Vorverarbeitungseffekt",
      hyperparameter: "Hyperparameter-Sensitivität",
      bias_variance: "Bias-Varianz",
    ...
    toolbar: {
      ...
      partition: "Partition",
      export: "Exportieren",
      exportPng: "Panels als PNG exportieren",
    ...
    filters: {
      ...
      hideOutliers: "Ausreißer ausblenden",
      onlyOutliers: "Nur Ausreißer",
      selectedOnly: "Nur Ausgewählte",
      unselectedOnly: "Nur Nicht-Ausgewählte",
    },
    groupModes: {
  ...
  analysis: {
    ...
    transfer: {
      title: "Transfer-Analyse",
      description: "Bewerten Sie den Einfluss der Vorverarbeitung auf die Abstände zwischen Datensätzen für den Kalibrationstransfer",
    },
    gettingStarted: {
  ...
  shap: {
    ...
    selectModel: "Wählen Sie ein Modell zur Erklärung",
    ...
    features: {
      ...
      waterfall: "Probenaufschlüsselung",
    },
    form: {
    ...
    spectral: {
      description: "Wichtige Wellenlängenbereiche, hervorgehoben im mittleren Spektrum. Dunklere Farben zeigen höhere Wichtigkeit an.",
    },
    beeswarm: {
      description: "Verteilung der SHAP-Werte über Proben. Jeder Punkt ist eine Probe, gefärbt nach Merkmalswert.",
    },
    waterfall: {
