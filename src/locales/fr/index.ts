  ...
  settings: {
    ...
    workspace: {
      ...
      backup: {
        ...
        description: "Configurez les sauvegardes automatiques de l'espace de travail",
        enabled: "Activer les sauvegardes automatiques",
        interval: "Intervalle de sauvegarde",
        intervalHours: "{{count}} heure",
        intervalHours_other: "{{count}} heures",
        maxBackups: "Nombre maximum de sauvegardes à conserver",
        includeResults: "Inclure les résultats",
        includeModels: "Inclure les modèles",
        saveSettings: "Enregistrer les paramètres de sauvegarde",
