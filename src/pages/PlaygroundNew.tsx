/**
 * PlaygroundNew - Updated Playground page with backend integration
 *
 ...
 * - Supports real-time pipeline execution
 * - Supports workspace dataset loading
 * - Uses new visualization components (Phase 3)
 * - Export to Pipeline Editor and JSON
...
import { PlaygroundSidebarNew, MainCanvasNew } from '@/components/playground';
...
import type { OperatorDefinition, UnifiedOperator } from '@/types/playground';
